...
|---|---|
| A role reference (Image_X / Strategist-style) | [`image-searcher.md`](../../references/image-searcher.md), [`strategist.md`](../../references/strategist.md) |
| A shared spec across roles | [`image-base.md`](../../references/image-base.md), [`shared-standards.md`](../../references/shared-standards.md) |
| A technical / format spec | [`canvas-formats.md`](../../references/canvas-formats.md), [`svg-image-embedding.md`](../../references/svg-image-embedding.md), [`image-layout-spec.md`](../../references/image-layout-spec.md) |
| Workflow runbook | [`workflows/verify-charts.md`](../../workflows/verify-charts.md) |
